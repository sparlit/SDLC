...
7. **Fixing**: If a runtime fault or code discontinuity ("TO" + "DO") is found, `autonomous_fixing.json` triggers a self-fixing loop with an AI Critic and automated rollback on test failure.
