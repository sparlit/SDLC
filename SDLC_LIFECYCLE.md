...
7. **Fixing**: If a runtime error or code gap (COMPLETED_TASK) is found, `autonomous_fixing.json` triggers a self-fixing loop with an AI Critic and automated rollback on test failure.
